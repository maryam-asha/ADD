...
return [
    ...
    'access' => [
        ...
        'lock_not_found' => 'رمز الاستجابة السريعة هذا لا يطابق أي قفل.',
        'no_active_grant' => 'لا تملك حالياً صلاحية وصول فعالة لهذا القفل.',
        'gateway_offline' => 'بوابة هذا القفل غير متصلة حالياً — الرجاء استخدام رمز لوحة المفاتيح بدلاً من ذلك.',
        'unlock_failed' => 'تعذّر فتح القفل. الرجاء المحاولة مجدداً أو استخدام رمز لوحة المفاتيح.',
    ],
